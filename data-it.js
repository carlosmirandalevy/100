const ITEMS = [
  // ===== SCRITTURA E CONTENUTI (1-10) =====
  {id:1, title:"Scrivi Saggi e Relazioni", subtitle:"L'IA ti aiuta a strutturare argomentazioni e ricerche", category:"writing",
    ...
    steps:["Scegli l'argomento e incolla eventuale materiale di riferimento nell'IA","Chiedi all'IA di aiutarti a fare brainstorming su tesi e argomentazioni chiave","Richiedi una scaletta con introduzione, paragrafi centrali e conclusione","Scrivi la bozza usando la scaletta, poi chiedi all'IA di revisionarla e suggerire miglioramenti"],
  ...
  {id:2, title:"Riassumi Articoli Lunghi", subtitle:"Estrai i punti chiave da qualsiasi testo", category:"writing",
    ...
    steps:["Copia il testo che vuoi riassumere","Incollalo nella chat dell'IA","Chiedi un riassunto della lunghezza desiderata","Richiedi punti elenco per una lettura rapida"],
  ...
  {id:3, title:"Traduci Testi in Qualsiasi Lingua", subtitle:"Abbatti le barriere linguistiche all'istante", category:"writing",
    ...
    steps:["Digita o incolla il testo da tradurre","Specifica le lingue di partenza e di arrivo","Chiedi all'IA di tradurre mantenendo il tono","Richiedi traduzioni alternative se necessario"],
  ...
  {id:4, title:"Crea Articoli per Blog", subtitle:"Genera contenuti coinvolgenti su qualsiasi argomento", category:"writing",
    ...
    steps:["Definisci l'argomento del blog e il pubblico target","Chiedi all'IA di suggerire 5 opzioni di titoli accattivanti","Scegli un titolo e richiedi una bozza completa con sezioni","Rivedi, aggiungi la tua voce personale e modifica"],
  ...
  {id:5, title:"Scrivi Poesie e Testi Creativi", subtitle:"Esplora l'espressione creativa con l'IA", category:"writing",
    ...
    steps:["Descrivi il tema, l'atmosfera o l'emozione che vuoi esprimere","Scegli una forma: verso libero, sonetto, haiku, racconto, ecc.","Chiedi all'IA di generare una prima bozza","Itera e perfeziona, aggiungendo il tuo tocco personale"],
  ...
  {id:6, title:"Scrivi Testi di Canzoni", subtitle:"Crea testi in qualsiasi genere o stile", category:"writing",
    ...
    steps:["Descrivi il genere, l'atmosfera e il tema della canzone","Specifica la struttura: strofa, ritornello, bridge","Chiedi all'IA di generare il testo","Perfeziona il ritmo e le scelte lessicali per adattarle alla melodia"],
  ...
  {id:7, title:"Crea Didascalie per Social Media", subtitle:"Post coinvolgenti per qualsiasi piattaforma", category:"writing",
    ...
    steps:["Descrivi la foto, il video o il contenuto che stai pubblicando","Specifica la piattaforma (Instagram, TikTok, Twitter)","Chiedi più opzioni di didascalia","Scegli e personalizza la tua preferita"],
  ...
  {id:8, title:"Correggi e Revisiona Testi", subtitle:"Perfeziona la tua scrittura", category:"writing",
    ...
    steps:["Incolla il tuo testo nell'IA","Chiedile di controllare grammatica, ortografia e chiarezza","Rivedi le modifiche suggerite","Chiedi miglioramenti stilistici se necessario"],
  ...
  {id:9, title:"Riscrivi in Toni Diversi", subtitle:"Formale, informale, divertente, persuasivo", category:"writing",
    ...
    steps:["Incolla il tuo testo originale","Specifica il tono desiderato","Chiedi all'IA di riscrivere mantenendo il messaggio","Confronta le versioni e scegli la migliore"],
  ...
  {id:10, title:"Genera Bozze di Email", subtitle:"Comunicazione professionale semplificata", category:"writing",
    ...
    steps:["Descrivi a chi stai scrivendo e perché","Specifica il tono (formale, semi-formale, amichevole)","Chiedi all'IA di scrivere la bozza dell'email","Personalizzala con i tuoi dettagli specifici"],
  ...
  // ===== APPRENDIMENTO E ISTRUZIONE (11-20) =====
  {id:11, title:"Crea Flashcard di Studio", subtitle:"Memorizza qualsiasi cosa in modo efficiente", category:"learning",
    ...
    steps:["Incolla il tuo materiale di studio o descrivi l'argomento","Chiedi all'IA di creare flashcard con domande e risposte","Esportale in un'app di flashcard come Anki o Quizlet","Studia usando la ripetizione spaziata"],
  ...
  {id:12, title:"Spiega Concetti Complessi in Modo Semplice", subtitle:"Comprendi qualsiasi cosa al tuo livello", category:"learning",
    ...
    steps:["Descrivi il concetto con cui hai difficoltà","Indica all'IA il tuo livello attuale di comprensione","Chiedi analogie ed esempi dal mondo reale","Fai domande specifiche fino a quando non capisci"],
  ...
  {id:13, title:"Genera Quiz di Pratica", subtitle:"Mettiti alla prova su qualsiasi argomento", category:"learning",
    ...
    steps:["Specifica la materia e gli argomenti da coprire","Scegli i tipi di domande (scelta multipla, risposta breve, ecc.)","Imposta il livello di difficoltà","Fai il quiz, poi chiedi all'IA di correggerlo e spiegare le risposte"],
  ...
  {id:14, title:"Aiuto con Problemi di Matematica", subtitle:"Soluzioni spiegate passo dopo passo", category:"learning",
    ...
    steps:["Digita o fotografa il tuo problema di matematica","Chiedi all'IA di risolverlo passo dopo passo","Chiedi spiegazioni per qualsiasi passaggio che non capisci","Esercitati con problemi simili per consolidare l'apprendimento"],
  ...
  {id:15, title:"Impara una Nuova Lingua", subtitle:"Pratica conversazione e grammatica", category:"learning",
    ...
    steps:["Indica all'IA quale lingua vuoi praticare e il tuo livello","Inizia una conversazione in quella lingua","Chiedi all'IA di correggere i tuoi errori e spiegare la grammatica","Pratica abilità specifiche: vocabolario, coniugazioni, ascolto"],
  ...
  {id:16, title:"Crea Guide di Studio", subtitle:"Organizza il tuo materiale di apprendimento", category:"learning",
    ...
    steps:["Elenca tutti gli argomenti e i capitoli che devi studiare","Fornisci eventuali appunti o concetti chiave","Chiedi all'IA di creare una guida di studio organizzata","Stampala o salvala per la revisione"],
  ...
  {id:17, title:"Aiuto con i Compiti", subtitle:"Capire, non copiare", category:"learning",
    ...
    steps:["Descrivi il problema o la domanda dei compiti","Chiedi all'IA di spiegare l'approccio, non solo la risposta","Lavora da solo con la guida dell'IA","Controlla la tua risposta e chiedi un feedback"],
  ...
  {id:18, title:"Comprendi gli Eventi Storici", subtitle:"Dai vita alla storia", category:"learning",
    ...
    steps:["Indica l'evento o il periodo storico che stai studiando","Chiedi all'IA di spiegarlo con contesto e prospettive multiple","Richiedi connessioni con eventi moderni","Chiedi una cronologia o una catena causa-effetto"],
  ...
  {id:19, title:"Impara Concetti di Programmazione", subtitle:"Inizia a programmare da zero", category:"learning",
    ...
    steps:["Indica all'IA la tua esperienza attuale di programmazione (principiante, ecc.)","Scegli un linguaggio da imparare (Python è ottimo per iniziare)","Chiedi spiegazioni dei concetti con esempi di codice","Esercitati con gli esercizi e chiedi all'IA di revisionare il tuo codice"],
  ...
  {id:20, title:"Crea Mappe Mentali e Scalette", subtitle:"Organizza i tuoi pensieri visivamente", category:"learning",
    ...
    steps:["Descrivi l'argomento che vuoi organizzare","Chiedi all'IA di creare una scaletta gerarchica o una mappa mentale","Personalizza la profondità e le aree di focus","Esporta in uno strumento di mappe mentali se necessario"],
  ...
  {id:103, title:"Ottieni Istruzioni Passo dopo Passo", subtitle:"Chiedi all'IA come fare qualsiasi cosa", category:"learning",
    ...
    steps:["Pensa a qualcosa che vuoi imparare a fare","Chiedi all'IA di spiegarlo passo dopo passo","Fai domande se qualche passaggio non è chiaro","Segui le istruzioni e chiedi aiuto se ti blocchi"],
  ...
  // ===== ARTE E DESIGN (21-30) =====
  {id:21, title:"Genera Opere d'Arte Digitali", subtitle:"Crea immagini partendo da descrizioni", category:"art",
    ...
    steps:["Visualizza cosa vuoi creare","Scrivi una descrizione dettagliata (il 'prompt')","Scegli un generatore di immagini IA","Genera, itera e perfeziona la tua creazione"],
    ...
    links:[{name:"Midjourney",url:"https://midjourney.com"},{name:"Leonardo AI",url:"https://leonardo.ai"},{name:"Freepik",url:"https://freepik.com"},{name:"Vedi il nostro portfolio media IA",url:"https://xperto.media/portfolio"}]},

  {id:22, title:"Progetta Loghi e Branding", subtitle:"Costruisci la tua identità visiva", category:"art",
    ...
    steps:["Descrivi il tuo brand: nome, valori, pubblico target","Chiedi all'IA idee per il concept del logo","Genera opzioni visive con strumenti di immagini IA","Perfeziona il tuo preferito nel design finale"],
    ...
    links:[{name:"Canva",url:"https://www.canva.com"},{name:"Looka",url:"https://looka.com"},{name:"Vedi il nostro portfolio media IA",url:"https://xperto.media/portfolio"}]},

  {id:23, title:"Crea Palette di Colori", subtitle:"Trova combinazioni di colori perfette", category:"art",
    ...
    steps:["Descrivi l'atmosfera o lo scopo del tuo progetto","Chiedi all'IA suggerimenti per la palette colori con codici hex","Visualizza i colori in anteprima in uno strumento di design","Regola fino a trovare la combinazione perfetta"],
    ...
    links:[{name:"Coolors",url:"https://coolors.co"},{name:"Adobe Color",url:"https://color.adobe.com"},{name:"Vedi il nostro portfolio media IA",url:"https://xperto.media/portfolio"}]},

  {id:24, title:"Modifica e Migliora le Foto", subtitle:"Fotoritocco professionale con l'IA", category:"art",
    ...
    steps:["Carica la tua foto in uno strumento di editing IA","Descrivi cosa vuoi modificare","Lascia che l'IA elabori la modifica","Perfeziona i risultati"],
    ...
    links:[{name:"Remove.bg",url:"https://www.remove.bg"},{name:"Canva",url:"https://www.canva.com"},{name:"Vedi il nostro portfolio media IA",url:"https://xperto.media/portfolio"}]},

  {id:25, title:"Genera Sfondi e Wallpaper", subtitle:"Sfondi personalizzati per i tuoi dispositivi", category:"art",
    ...
    steps:["Decidi lo stile e il tema che desideri","Scrivi un prompt dettagliato per l'immagine","Genera con il rapporto d'aspetto corretto per il tuo dispositivo","Scarica e imposta come sfondo"],
  ...
  {id:26, title:"Progetta Grafiche per Social Media", subtitle:"Contenuti visivi accattivanti", category:"art",
    ...
    steps:["Definisci la piattaforma e le dimensioni necessarie","Descrivi il design che vuoi","Genera usando strumenti IA o le funzioni IA di Canva","Aggiungi testo e tocchi finali"],
    ...
    links:[{name:"Canva",url:"https://www.canva.com"},{name:"Adobe Express",url:"https://www.adobe.com/express"},{name:"Vedi il nostro portfolio media IA",url:"https://xperto.media/portfolio"}]},

  {id:27, title:"Crea Meme", subtitle:"Umorismo con l'assistenza dell'IA", category:"art",
    ...
    steps:["Pensa a un concetto o una situazione divertente","Chiedi all'IA di scrivere didascalie per meme","Genera o trova un'immagine corrispondente","Combina testo e immagine usando un creatore di meme"],
    ...
    links:[{name:"imgflip Meme Generator",url:"https://imgflip.com/memegenerator"},{name:"Canva",url:"https://www.canva.com"},{name:"Vedi il nostro portfolio media IA",url:"https://xperto.media/portfolio"}]},

  {id:28, title:"Genera Strisce a Fumetti", subtitle:"Narrazione visiva con l'IA", category:"art",
    ...
    steps:["Scrivi il copione del fumetto: vignette, dialoghi, azione","Descrivi l'aspetto di ogni vignetta per la generazione di immagini IA","Genera un'arte dei personaggi coerente","Assembla le vignette con i fumetti di dialogo"],
    ...
    links:[{name:"Pixton",url:"https://www.pixton.com"},{name:"Canva",url:"https://www.canva.com"},{name:"Vedi il nostro portfolio media IA",url:"https://xperto.media/portfolio"}]},

  {id:29, title:"Progetta Slide per Presentazioni", subtitle:"Presentazioni belle in pochi minuti", category:"art",
    ...
    steps:["Delinea il contenuto della presentazione","Chiedi all'IA di suggerire layout e design per le slide","Genera elementi visivi per ogni slide","Assembla in PowerPoint, Google Slides o Canva"],
    ...
    links:[{name:"Canva Presentations",url:"https://www.canva.com/presentations"},{name:"Gamma",url:"https://gamma.app"},{name:"Vedi il nostro portfolio media IA",url:"https://xperto.media/portfolio"}]},

  {id:30, title:"Crea Mood Board", subtitle:"Collezioni di ispirazione visiva", category:"art",
    ...
    steps:["Descrivi il progetto o l'estetica che cerchi","Chiedi all'IA di suggerire elementi visivi, colori, texture","Genera immagini di riferimento con l'IA","Compila tutto in uno strumento per mood board"],
    ...
    links:[{name:"Pinterest",url:"https://www.pinterest.com"},{name:"Milanote",url:"https://milanote.com"},{name:"Vedi il nostro portfolio media IA",url:"https://xperto.media/portfolio"}]},

  // ===== MUSICA E AUDIO (31-40) =====
  {id:31, title:"Componi Musica Originale", subtitle:"Crea melodie e canzoni complete", category:"music",
    ...
    steps:["Scegli il genere e l'atmosfera","Descrivi la canzone che vuoi o scrivi il testo","Usa un generatore musicale IA","Scarica e modifica se necessario"],
    ...
    links:[{name:"Suno",url:"https://suno.com"},{name:"AIVA",url:"https://www.aiva.ai"},{name:"Ascolta i nostri artisti potenziati dall'IA",url:"https://maimusic.org"}]},

  {id:32, title:"Crea Beat e Strumentali", subtitle:"Produci basi musicali", category:"music",
    ...
    steps:["Definisci il genere e il tempo (BPM)","Descrivi lo stile del beat e gli strumenti","Genera con uno strumento musicale IA","Scarica e usa nei tuoi progetti"],
    ...
    links:[{name:"Suno",url:"https://suno.com"},{name:"BandLab",url:"https://www.bandlab.com"},{name:"Ascolta i nostri artisti potenziati dall'IA",url:"https://maimusic.org"}]},

  {id:33, title:"Genera Effetti Sonori", subtitle:"Audio personalizzato per qualsiasi progetto", category:"music",
    ...
    steps:["Descrivi l'effetto sonoro di cui hai bisogno","Specifica durata e stile","Genera usando strumenti audio IA","Scarica e integra nel tuo progetto"],
    ...
    links:[{name:"ElevenLabs",url:"https://elevenlabs.io"},{name:"Freesound",url:"https://freesound.org"},{name:"Ascolta i nostri artisti potenziati dall'IA",url:"https://maimusic.org"}]},

  {id:34, title:"Scrivi Arrangiamenti Musicali", subtitle:"Orchestrazione completa con l'aiuto dell'IA", category:"music",
    ...
    steps:["Condividi la tua melodia o progressione di accordi","Descrivi lo stile che desideri","Chiedi all'IA suggerimenti per l'arrangiamento","Implementa nel tuo DAW o strumento musicale"],
    ...
    links:[{name:"AIVA",url:"https://www.aiva.ai"},{name:"BandLab",url:"https://www.bandlab.com"},{name:"Ascolta i nostri artisti potenziati dall'IA",url:"https://maimusic.org"}]},

  {id:35, title:"Crea Copioni per Podcast", subtitle:"Struttura il tuo contenuto audio", category:"music",
    ...
    steps:["Definisci l'argomento del podcast e il pubblico target","Chiedi all'IA di creare una scaletta della puntata","Sviluppa i punti di discussione per ogni segmento","Scrivi copioni per l'intro e l'outro"],
    ...
    links:[{name:"Anchor/Spotify for Podcasters",url:"https://podcasters.spotify.com"},{name:"Descript",url:"https://www.descript.com"},{name:"Ascolta i nostri artisti potenziati dall'IA",url:"https://maimusic.org"}]},

  {id:36, title:"Genera Narrazioni Vocali", subtitle:"Text-to-speech per i tuoi progetti", category:"music",
    ...
    steps:["Scrivi il tuo copione o testo","Scegli uno stile vocale e la lingua","Genera l'audio con uno strumento vocale IA","Modifica e integra nel tuo progetto"],
    ...
    links:[{name:"ElevenLabs",url:"https://elevenlabs.io"},{name:"Play.ht",url:"https://play.ht"},{name:"Ascolta i nostri artisti potenziati dall'IA",url:"https://maimusic.org"}]},

  {id:37, title:"Mixa e Masterizza l'Audio", subtitle:"Qualità audio professionale con l'IA", category:"music",
    ...
    steps:["Registra o produci il tuo brano","Carica su un servizio di mastering IA","Scegli uno stile di riferimento o lascia decidere all'IA","Scarica la versione masterizzata"],
    ...
    links:[{name:"LANDR",url:"https://www.landr.com"},{name:"BandLab",url:"https://www.bandlab.com"},{name:"Ascolta i nostri artisti potenziati dall'IA",url:"https://maimusic.org"}]},

  {id:38, title:"Crea Suonerie e Notifiche", subtitle:"Personalizza i tuoi dispositivi", category:"music",
    ...
    steps:["Decidi lo stile e la lunghezza (15-30 secondi per le suonerie)","Genera un breve pezzo musicale con l'IA","Taglia e formatta nel tipo di file corretto","Impostala come suoneria"],
    ...
    links:[{name:"Suno",url:"https://suno.com"},{name:"Soundraw",url:"https://soundraw.io"},{name:"Ascolta i nostri artisti potenziati dall'IA",url:"https://maimusic.org"}]},

  {id:39, title:"Genera Paesaggi Sonori Ambientali", subtitle:"Suoni per la concentrazione e il relax", category:"music",
    ...
    steps:["Descrivi l'atmosfera che desideri","Specifica lo scopo (concentrazione, sonno, relax)","Genera con strumenti musicali IA","Riproduci durante le sessioni di studio o riposo"],
    ...
    links:[{name:"Noisli",url:"https://www.noisli.com"},{name:"myNoise",url:"https://mynoise.net"},{name:"Ascolta i nostri artisti potenziati dall'IA",url:"https://maimusic.org"}]},

  {id:40, title:"Trascrivi Audio in Testo", subtitle:"Converti il parlato in scrittura", category:"music",
    ...
    steps:["Registra o ottieni il tuo file audio","Carica su un servizio di trascrizione IA","Rivedi e modifica la trascrizione","Usa il testo per appunti, sottotitoli o documentazione"],
    ...
    links:[{name:"Otter.ai",url:"https://otter.ai"},{name:"Descript",url:"https://www.descript.com"},{name:"Ascolta i nostri artisti potenziati dall'IA",url:"https://maimusic.org"}]},

  // ===== VIDEO E ANIMAZIONE (41-50) =====
  {id:41, title:"Genera Video Brevi", subtitle:"Creazione video con l'IA", category:"video",
    ...
    steps:["Scrivi una descrizione del video che vuoi","Scegli uno strumento di generazione video IA","Genera e rivedi l'output","Modifica e combina le clip se necessario"],
    ...
    links:[{name:"Runway",url:"https://runwayml.com"},{name:"Pika",url:"https://pika.art"},{name:"Sora",url:"https://sora.chatgpt.com/"},{name:"Kling AI",url:"https://klingai.com"},{name:"Freepik",url:"https://freepik.com"},{name:"Vedi il nostro portfolio media IA",url:"https://xperto.media/portfolio"}]},

  {id:42, title:"Crea Animazioni", subtitle:"Dai movimento alle idee", category:"video",
    ...
    steps:["Pianifica la tua animazione: fai lo storyboard dei fotogrammi chiave","Scegli tra 2D, 3D o motion graphics","Usa strumenti di animazione IA per generare","Modifica il timing e aggiungi il suono"],
    ...
    links:[{name:"Runway",url:"https://runwayml.com"},{name:"Canva",url:"https://www.canva.com"},{name:"Vedi il nostro portfolio media IA",url:"https://xperto.media/portfolio"}]},

  {id:43, title:"Modifica Clip Video", subtitle:"Editing professionale semplificato", category:"video",
    ...
    steps:["Importa il tuo girato grezzo","Usa strumenti IA per l'editing automatico (tagli, colore, audio)","Aggiungi transizioni ed effetti","Esporta nel formato giusto per la tua piattaforma"],
    ...
    links:[{name:"CapCut",url:"https://www.capcut.com"},{name:"DaVinci Resolve",url:"https://www.blackmagicdesign.com/products/davinciresolve"},{name:"Vedi il nostro portfolio media IA",url:"https://xperto.media/portfolio"}]},

  {id:44, title:"Aggiungi Sottotitoli Automaticamente", subtitle:"Accessibilità e coinvolgimento", category:"video",
    ...
    steps:["Carica il tuo video in uno strumento di sottotitolazione","L'IA trascrive e sincronizza i sottotitoli","Rivedi e correggi eventuali errori","Esporta nel formato preferito (SRT, VTT, integrato)"],
    ...
    links:[{name:"Veed.io",url:"https://www.veed.io"},{name:"Kapwing",url:"https://www.kapwing.com"},{name:"Vedi il nostro portfolio media IA",url:"https://xperto.media/portfolio"}]},

  {id:45, title:"Crea Copioni Video", subtitle:"Struttura il tuo contenuto video", category:"video",
    ...
    steps:["Definisci l'argomento del video, la piattaforma e la durata target","Chiedi all'IA di scrivere un copione con note sui tempi","Includi ganci, transizioni e CTA","Esercitati a leggerlo ad alta voce e regola"],
    ...
    tools:["ChatGPT","Claude","Gemini"],
    links:[{name:"ChatGPT",url:"https://chat.openai.com"},{name:"Claude",url:"https://claude.ai"},{name:"Vedi il nostro portfolio media IA",url:"https://xperto.media/portfolio"}]},

  {id:46, title:"Genera Storyboard", subtitle:"Pianifica la tua narrativa visiva", category:"video",
    ...
    steps:["Scrivi il concept o il copione del video","Chiedi all'IA di suddividerlo in pannelli di storyboard","Genera frame visivi con strumenti di immagini IA","Disponi e annota lo storyboard"],
    ...
    links:[{name:"Canva",url:"https://www.canva.com"},{name:"ChatGPT",url:"https://chat.openai.com"},{name:"Vedi il nostro portfolio media IA",url:"https://xperto.media/portfolio"}]},

  {id:47, title:"Crea Miniature Video", subtitle:"Immagini di anteprima che invitano al click", category:"video",
    ...
    steps:["Analizza miniature di successo nella tua nicchia","Chiedi all'IA idee per il concept della miniatura","Genera o progetta l'immagine della miniatura","Aggiungi testo in grassetto e testa versioni diverse"],
    ...
    links:[{name:"Canva",url:"https://www.canva.com"},{name:"Midjourney",url:"https://midjourney.com"},{name:"Vedi il nostro portfolio media IA",url:"https://xperto.media/portfolio"}]},

  {id:48, title:"Crea Contenuti Time-Lapse", subtitle:"Comprimi il tempo visivamente", category:"video",
    ...
    steps:["Scegli il soggetto (creazione artistica, natura, costruzione, ecc.)","Configura la registrazione o usa la generazione IA","Elabora il girato con regolazioni di velocità","Aggiungi musica e tocchi finali"],
    ...
    links:[{name:"CapCut",url:"https://www.capcut.com"},{name:"Runway",url:"https://runwayml.com"},{name:"Vedi il nostro portfolio media IA",url:"https://xperto.media/portfolio"}]},

  {id:49, title:"Crea Transizioni Video", subtitle:"Flusso visivo fluido tra le scene", category:"video",
    ...
    steps:["Identifica dove servono le transizioni nel tuo video","Scegli stili di transizione che si adattino all'atmosfera del contenuto","Applica usando le funzioni IA del tuo software di editing","Regola il timing per un flusso fluido"],
  ...
  {id:50, title:"Genera Effetti Visivi", subtitle:"Aggiungi la magia del cinema ai tuoi video", category:"video",
    ...
    steps:["Filma il tuo girato base","Identifica quali VFX vuoi aggiungere","Usa strumenti VFX IA per generare gli effetti","Componi e renderizza il video finale"],
    ...
    links:[{name:"Runway",url:"https://runwayml.com"},{name:"HitFilm",url:"https://fxhome.com/product/hitfilm"},{name:"Vedi il nostro portfolio media IA",url:"https://xperto.media/portfolio"}]},

  {id:101, title:"Anima Foto e Immagini", subtitle:"Dai vita alle immagini statiche", category:"video",
    ...
    steps:["Scegli una foto o immagine da animare","Caricala su uno strumento di animazione IA","Descrivi il movimento desiderato (panoramica, movimento del personaggio, ecc.)","Genera, rivedi e perfeziona l'animazione"],
    ...
    links:[{name:"Runway",url:"https://runwayml.com"},{name:"Pika",url:"https://pika.art"},{name:"MidJourney",url:"https://midjourney.com"},{name:"Kling AI",url:"https://klingai.com"},{name:"Vedi il nostro portfolio media IA",url:"https://xperto.media/portfolio"}]},

  {id:102, title:"Crea Immagini Usando Riferimenti", subtitle:"Guida l'IA con le tue immagini", category:"art",
    ...
    steps:["Scegli la tua immagine di riferimento (personaggio, oggetto o stile)","Caricala in uno strumento di immagini IA che supporta i riferimenti","Descrivi cosa vuoi: nuova scena, stile o variazioni","Genera e itera fino a ottenere il risultato perfetto"],
    ...
    links:[{name:"MidJourney",url:"https://midjourney.com"},{name:"Gemini",url:"https://gemini.google.com"},{name:"Vedi il nostro portfolio media IA",url:"https://xperto.media/portfolio"}]},

  {id:105, title:"Crea Avatar Parlanti", subtitle:"Presentatori video alimentati dall'IA", category:"video",
    ...
    steps:["Scrivi il copione o i punti di discussione","Scegli un avatar (o carica la tua foto)","Seleziona una voce e la lingua","Genera il video e scarica"],
    ...
    links:[{name:"HeyGen",url:"https://heygen.com"},{name:"Synthesia",url:"https://www.synthesia.io"},{name:"D-ID",url:"https://www.d-id.com"},{name:"Vedi il nostro portfolio media IA",url:"https://xperto.media/portfolio"}]},

  // ===== PRODUTTIVITÀ (51-60) =====
  {id:51, title:"Crea Liste di Cose da Fare e Piani", subtitle:"Organizza la tua vita con l'IA", category:"productivity",
    ...
    steps:["Descrivi il tuo obiettivo o progetto","Chiedi all'IA di suddividerlo in compiti con priorità","Imposta scadenze e dipendenze","Rivedi e aggiusta il piano quotidianamente"],
  ...
  {id:52, title:"Organizza Appunti e Idee", subtitle:"Struttura i tuoi pensieri", category:"productivity",
    ...
    steps:["Scarica tutti i tuoi appunti e idee nell'IA","Chiedile di categorizzarli e organizzarli","Crea un sistema strutturato","Configuralo nella tua app di appunti preferita"],
  ...
  {id:53, title:"Genera Ordini del Giorno per Riunioni", subtitle:"Conduci riunioni efficaci", category:"productivity",
    ...
    steps:["Definisci lo scopo della riunione e i partecipanti","Elenca gli argomenti da trattare","Chiedi all'IA di creare un ordine del giorno con tempi","Condividi con i partecipanti prima della riunione"],
  ...
  {id:54, title:"Crea Formule per Fogli di Calcolo", subtitle:"Padroneggia Excel e Google Sheets", category:"productivity",
    ...
    steps:["Descrivi quali dati hai e cosa vuoi calcolare","Specifica se è per Excel o Google Sheets","Chiedi all'IA di scrivere la formula","Testala con i tuoi dati e regola se necessario"],
  ...
  {id:55, title:"Automatizza Compiti Ripetitivi", subtitle:"Lavora in modo intelligente, non più duro", category:"productivity",
    ...
    steps:["Identifica un compito che fai ripetutamente","Descrivi il compito passo dopo passo all'IA","Chiedi una soluzione di automazione","Configurala usando gli strumenti consigliati"],
  ...
  {id:56, title:"Crea Dashboard Personali", subtitle:"Monitora ciò che conta per te", category:"productivity",
    ...
    steps:["Decidi cosa vuoi monitorare","Chiedi all'IA di progettare un layout per la dashboard","Costruiscila in Notion, Sheets o il tuo strumento preferito","Aggiornala regolarmente e analizza le tendenze"],
  ...
  {id:57, title:"Crea Cronologie di Progetto", subtitle:"Pianifica qualsiasi progetto visivamente", category:"productivity",
    ...
    steps:["Descrivi il tuo progetto e la scadenza","Elenca tutti i compiti coinvolti","Chiedi all'IA di creare una cronologia con traguardi","Monitora i progressi rispetto alla cronologia"],
  ...
  {id:58, title:"Genera Checklist", subtitle:"Non dimenticare mai un passaggio", category:"productivity",
    ...
    steps:["Descrivi il compito o l'evento per cui ti stai preparando","Chiedi all'IA di generare una checklist completa","Personalizza e dai priorità agli elementi","Usala man mano, spuntando gli elementi completati"],
  ...
  {id:59, title:"Organizza i File Digitali", subtitle:"Metti ordine nella tua vita digitale", category:"productivity",
    ...
    steps:["Descrivi la tua situazione attuale dei file","Chiedi all'IA di progettare un sistema di organizzazione","Crea la struttura delle cartelle","Sposta i file e mantieni il sistema"],
  ...
  {id:60, title:"Crea Template per Documenti", subtitle:"Formati riutilizzabili per tutto", category:"productivity",
    ...
    steps:["Identifica i documenti che crei frequentemente","Descrivi il formato e lo stile necessari","Chiedi all'IA di generare un template","Salva e riutilizza per i documenti futuri"],
  ...
  // ===== CODING E TECNOLOGIA (61-70) =====
  {id:61, title:"Scrivi Codice in Qualsiasi Linguaggio", subtitle:"Python, JavaScript e altro", category:"coding",
    ...
    steps:["Descrivi cosa vuoi che il codice faccia in linguaggio naturale","Specifica il linguaggio di programmazione","Chiedi all'IA di scrivere il codice con commenti","Testalo, capiscilo e modifica secondo necessità"],
  ...
  {id:62, title:"Fai il Debug del Codice Esistente", subtitle:"Trova e correggi gli errori", category:"coding",
    ...
    steps:["Incolla il codice e descrivi l'errore o il comportamento inaspettato","Includi eventuali messaggi di errore","Chiedi all'IA di trovare il bug e spiegarlo","Applica la correzione e testa"],
  ...
  {id:63, title:"Crea Siti Web", subtitle:"Costruisci la tua presenza online", category:"coding",
    ...
    steps:["Pianifica il tuo sito web: scopo, pagine, funzionalità","Descrivi il design e le funzionalità all'IA","L'IA genera il codice","Pubblica usando GitHub Pages, Netlify o Vercel"],
  ...
  {id:64, title:"Crea App Mobile", subtitle:"Trasforma le idee in app", category:"coding",
    ...
    steps:["Definisci la tua idea di app e le funzionalità principali","Scegli un framework o una piattaforma no-code","Usa l'IA per generare il codice o guidare la costruzione","Testa sul tuo dispositivo e itera"],
  ...
  {id:65, title:"Crea Estensioni per Browser", subtitle:"Personalizza la tua esperienza di navigazione", category:"coding",
    ...
    steps:["Definisci cosa vuoi che faccia la tua estensione","Chiedi all'IA di generare il codice dell'estensione","Caricala come estensione non pacchettizzata in Chrome","Testa e perfeziona"],
  ...
  {id:66, title:"Genera Query per Database", subtitle:"Lavora con i dati in modo efficiente", category:"coding",
    ...
    steps:["Descrivi la struttura del tuo database","Indica all'IA quali dati ti servono","L'IA scrive la query SQL","Testa e modifica secondo necessità"],
  ...
  {id:67, title:"Crea API", subtitle:"Collega sistemi tra loro", category:"coding",
    ...
    steps:["Definisci cosa deve fare la tua API","Scegli un framework (Express, Flask, FastAPI)","Chiedi all'IA di generare il codice dell'API","Testa con Postman o curl"],
  ...
  {id:68, title:"Costruisci Chatbot", subtitle:"Crea esperienze di IA conversazionale", category:"coding",
    ...
    steps:["Definisci lo scopo e la personalità del chatbot","Progetta il flusso conversazionale","Usa un'API IA o una piattaforma per chatbot","Testa e migliora in base alle interazioni degli utenti"],
  ...
  {id:69, title:"Automatizza Compiti Web", subtitle:"Scraping e automazione", category:"coding",
    ...
    steps:["Identifica il compito web che vuoi automatizzare","Chiedi all'IA di scrivere lo script di automazione","Testa su piccola scala prima","Programmalo per l'esecuzione automatica"],
  ...
  {id:70, title:"Crea Visualizzazioni di Dati", subtitle:"Grafici, diagrammi e dashboard", category:"coding",
    ...
    steps:["Prepara i tuoi dati (foglio di calcolo o CSV)","Descrivi cosa vuoi visualizzare","Chiedi all'IA di creare il codice di visualizzazione","Personalizza colori, etichette e stile"],
  ...
  {id:104, title:"Pubblica un Sito Web Gratuito su GitHub", subtitle:"Condividi le tue creazioni IA con il mondo", category:"coding",
    ...
    steps:["Crea un account gratuito su github.com","Crea un nuovo repository pubblico","Carica il tuo file HTML (chiamalo index.html)","Vai su Settings → Pages, seleziona il branch 'main' e salva","Il tuo sito è live su tuonomeutente.github.io/nome-repo/"],
  ...
  {id:107, title:"Crea Diagrammi con Mermaid", subtitle:"Diagrammi di flusso, timeline e altro da testo", category:"coding",
    ...
    steps:["Descrivi il diagramma di cui hai bisogno (diagramma di flusso, timeline, processo, ecc.)","Chiedi all'IA di generare codice Mermaid","Incolla il codice in un editor Mermaid live o strumento compatibile","Esporta come immagine o incorpora nei tuoi documenti"],
  ...
  // ===== BUSINESS E IMPRENDITORIA (71-80) =====
  {id:71, title:"Crea Piani Aziendali", subtitle:"Struttura la tua idea di startup", category:"business",
    ...
    steps:["Descrivi la tua idea imprenditoriale in dettaglio","Chiedi all'IA di creare un business plan strutturato","Ricerca e valida le ipotesi chiave","Perfeziona e presenta il tuo piano"],
  ...
  {id:72, title:"Genera Strategie di Marketing", subtitle:"Raggiungi il tuo pubblico efficacemente", category:"business",
    ...
    steps:["Definisci il tuo prodotto/servizio e pubblico target","Chiedi all'IA di creare una strategia di marketing","Scegli canali e tattiche adatti al tuo budget","Crea un calendario editoriale e parti"],
  ...
  {id:73, title:"Progetta Pitch Deck", subtitle:"Presenta le tue idee in modo convincente", category:"business",
    ...
    steps:["Definisci il tuo pitch: a chi presenti e perché","Chiedi all'IA di strutturare un deck di 10-12 slide","Crea ogni slide con messaggi chiave","Esercita la presentazione"],
  ...
  {id:74, title:"Analizza le Tendenze di Mercato", subtitle:"Comprendi il tuo mercato", category:"business",
    ...
    steps:["Definisci il mercato o settore che vuoi analizzare","Chiedi all'IA di ricercare le tendenze attuali","Verifica le fonti dei dati e valida i risultati","Crea un report di analisi di mercato"],
  ...
  {id:75, title:"Crea Proiezioni Finanziarie", subtitle:"Pianifica le tue finanze", category:"business",
    ...
    steps:["Descrivi il tuo modello di business e le fonti di ricavo","Fornisci eventuali stime dei costi","Chiedi all'IA di creare proiezioni finanziarie","Costruisci il foglio di calcolo e regola le ipotesi"],
  ...
  {id:76, title:"Scrivi Descrizioni di Prodotto", subtitle:"Vendi efficacemente con le parole", category:"business",
    ...
    steps:["Descrivi il tuo prodotto: caratteristiche, benefici, pubblico target","Specifica il tono e la piattaforma","Chiedi all'IA di scrivere più opzioni di descrizione","Testa quale funziona meglio"],
  ...
  {id:77, title:"Genera Nomi di Brand", subtitle:"Trova il nome perfetto", category:"business",
    ...
    steps:["Descrivi il tuo brand: valori, pubblico, settore","Chiedi all'IA di generare 20-30 opzioni di nomi","Riduci ai tuoi top 5","Verifica la disponibilità di dominio e social media"],
  ...
  {id:78, title:"Crea Sondaggi per i Clienti", subtitle:"Raccogli feedback preziosi", category:"business",
    ...
    steps:["Definisci cosa vuoi scoprire","Chiedi all'IA di progettare il sondaggio","Crealo in Google Forms o Typeform","Analizza i risultati con l'aiuto dell'IA"],
  ...
  {id:79, title:"Analizza i Competitor", subtitle:"Conosci il panorama del tuo mercato", category:"business",
    ...
    steps:["Identifica i tuoi 3-5 competitor principali","Chiedi all'IA di ricercare ciascuno","Crea una matrice di confronto","Identifica lacune e opportunità"],
  ...
  {id:80, title:"Redigi Comunicazioni Aziendali", subtitle:"Scrittura professionale per ogni situazione", category:"business",
    ...
    steps:["Definisci lo scopo, il destinatario e il risultato desiderato","Specifica il tono e il formato","Chiedi all'IA di redigere la comunicazione","Rivedi, personalizza e invia"],
  ...
  // ===== SCIENZA E RICERCA (81-90) =====
  {id:81, title:"Analizza Dataset", subtitle:"Trova pattern nei tuoi dati", category:"science",
    ...
    steps:["Prepara i tuoi dati (puliti e organizzati)","Descrivi i dati e cosa vuoi trovare","Chiedi all'IA di suggerire e eseguire analisi","Interpreta i risultati con l'aiuto dell'IA"],
  ...
  {id:82, title:"Crea Modelli Scientifici", subtitle:"Simula il mondo con l'IA", category:"science",
    ...
    steps:["Definisci cosa vuoi modellare","Identifica variabili e relazioni","Chiedi all'IA di creare il modello matematico","Implementa e visualizza in Python o un foglio di calcolo"],
  ...
  {id:83, title:"Genera Riassunti di Ricerca", subtitle:"Digerisci velocemente gli articoli accademici", category:"science",
    ...
    steps:["Trova l'articolo o il paper di ricerca","Incolla l'abstract o le sezioni chiave","Chiedi all'IA di riassumere in linguaggio semplice","Chiedi spiegazioni per sezioni specifiche"],
  ...
  {id:84, title:"Visualizza Dati Scientifici", subtitle:"Presenta i risultati chiaramente", category:"science",
    ...
    steps:["Prepara i tuoi dati","Scegli il tipo di visualizzazione giusto","Chiedi all'IA di creare il codice del grafico","Personalizza colori, etichette e formattazione"],
  ...
  {id:85, title:"Simula Esperimenti", subtitle:"Laboratorio virtuale", category:"science",
    ...
    steps:["Definisci l'esperimento che vuoi simulare","Specifica variabili e condizioni","Chiedi all'IA di creare una simulazione","Analizza i risultati virtuali e trai conclusioni"],
  ...
  {id:86, title:"Scrivi Relazioni di Laboratorio", subtitle:"Documenta i tuoi risultati correttamente", category:"science",
    ...
    steps:["Raccogli i dati e le osservazioni del tuo esperimento","Chiedi all'IA di aiutarti a strutturare ogni sezione","Scrivi la relazione seguendo il template","Fai revisionare all'IA per completezza e chiarezza"],
  ...
  {id:87, title:"Crea Poster Scientifici", subtitle:"Presentazioni pronte per conferenze", category:"science",
    ...
    steps:["Riassumi la tua ricerca nelle sezioni del poster","Chiedi all'IA suggerimenti per layout e design","Crea figure e grafiche","Assembla usando Canva o PowerPoint"],
  ...
  {id:88, title:"Genera Ipotesi", subtitle:"Inizia la tua ricerca nel modo giusto", category:"science",
    ...
    steps:["Descrivi la tua osservazione o domanda di ricerca","Chiedi all'IA di suggerire ipotesi verificabili","Valuta ogni ipotesi per verificabilità","Scegli la migliore per il tuo esperimento"],
  ...
  {id:89, title:"Analizza Paper di Ricerca", subtitle:"Lettura critica con l'aiuto dell'IA", category:"science",
    ...
    steps:["Trova e leggi il paper di ricerca","Incolla le sezioni chiave nell'IA","Chiedi un'analisi critica","Usa l'analisi per informare il tuo lavoro"],
  ...
  {id:90, title:"Crea Illustrazioni Scientifiche", subtitle:"Comunicazione scientifica visiva", category:"science",
    ...
    steps:["Descrivi il concetto scientifico da illustrare","Specifica lo stile e il livello di dettaglio","Genera con strumenti di immagini IA","Etichetta e annota l'illustrazione"],
  ...
  // ===== DIVERTIMENTO (91-100+) =====
  {id:91, title:"Pianifica Itinerari di Viaggio", subtitle:"Pianificazione viaggi con l'IA", category:"fun",
    ...
    steps:["Condividi destinazione, date, budget e interessi","Chiedi all'IA di creare un itinerario giorno per giorno","Personalizza in base alle tue preferenze","Salva i consigli su ristoranti e attività"],
  ...
  {id:92, title:"Crea Ricette dagli Ingredienti", subtitle:"Cucina con ciò che hai", category:"fun",
    ...
    steps:["Elenca gli ingredienti che hai a disposizione","Menziona eventuali restrizioni alimentari o preferenze","Chiedi all'IA suggerimenti per ricette","Segui le istruzioni di cucina passo dopo passo"],
  ...
  {id:93, title:"Genera Programmi di Allenamento", subtitle:"Piani fitness personalizzati", category:"fun",
    ...
    steps:["Condividi il tuo livello di fitness e obiettivi","Descrivi l'attrezzatura e il tempo disponibili","Chiedi all'IA di creare un piano di allenamento","Segui la routine e monitora i progressi"],
  ...
  {id:94, title:"Crea Budget Personali", subtitle:"Gestisci il tuo denaro saggiamente", category:"fun",
    ...
    steps:["Elenca tutte le tue fonti di reddito","Monitora le spese per un mese","Chiedi all'IA di creare un piano budget","Configura il monitoraggio in un foglio di calcolo o app"],
  ...
  {id:95, title:"Progetta la Tua Stanza dei Sogni", subtitle:"Interior design con l'IA", category:"fun",
    ...
    steps:["Descrivi le dimensioni della stanza e la configurazione attuale","Condividi le tue preferenze di stile e budget","Chiedi all'IA suggerimenti di design","Genera concept visivi con strumenti di immagini IA"],
  ...
  {id:96, title:"Crea Storie Personalizzate", subtitle:"Narrativa personalizzata solo per te", category:"fun",
    ...
    steps:["Descrivi i personaggi e l'ambientazione","Scegli il genere e il tono","Chiedi all'IA di scrivere la storia","Continua l'avventura aggiungendo le tue scelte"],
  ...
  {id:97, title:"Genera Giochi di Trivia e Quiz", subtitle:"Divertimento con gli amici", category:"fun",
    ...
    steps:["Scegli gli argomenti e il livello di difficoltà","Scegli un formato di gioco","Chiedi all'IA di generare domande e risposte","Organizza il gioco con amici o famiglia"],
  ...
  {id:98, title:"Pianifica Eventi e Feste", subtitle:"Celebrazioni perfette", category:"fun",
    ...
    steps:["Definisci il tipo di evento, dimensione e budget","Chiedi all'IA di creare un piano completo","Organizza i compiti e delega","Esegui e divertiti!"],
  ...
  {id:99, title:"Crea Vision Board", subtitle:"Visualizza i tuoi obiettivi", category:"fun",
    ...
    steps:["Rifletti sui tuoi obiettivi per il prossimo anno","Chiedi all'IA di aiutarti a definire obiettivi specifici e raggiungibili","Genera elementi visivi con l'IA","Assembla la tua vision board"],
  ...
  {id:100, title:"Costruisci il Tuo Personal Brand", subtitle:"Distinguiti online e offline", category:"fun",
    ...
    steps:["Definisci cosa ti rende unico","Crea la tua brand identity (visiva + verbale)","Costruisci la tua presenza online","Crea contenuti con costanza"],
  ...
  {id:109, title:"Crea un Videogioco Funzionante", subtitle:"Costruisci giochi giocabili con l'IA — da platform a sparatutto spaziali", category:"fun",
    ...
    steps:["Descrivi il tipo di gioco che vuoi (genere, meccaniche, stile artistico)","Chiedi all'IA di generare un singolo file HTML con tutto il JavaScript, CSS e grafica SVG incorporata","Apri il file nel browser e testalo","Itera: chiedi all'IA di aggiungere funzionalità, correggere bug, migliorare la grafica o perfezionare il gameplay","Per grafica avanzata, chiedi all'IA di usare Phaser o PixiJS tramite link CDN","Per supporto mobile, chiedi all'IA di aggiungere un joystick virtuale e pulsanti azione su schermo"],
  ...
  {id:110, title:"Crea Arte ASCII", subtitle:"Trasforma il testo in arte visiva usando caratteri", category:"fun",
    ...
    steps:["Descrivi cosa vuoi vedere come arte ASCII (un animale, un logo, una scena, una parola in lettere a blocchi)","Chiedi all'IA di generarla usando caratteri ASCII standard","Specifica la dimensione: piccola (10-15 righe), media (20-30 righe) o grande (40+ righe)","Chiedi variazioni o perfezionamenti — prova stili diversi"],
  ...
  {id:111, title:"Crea Animazioni di Arte ASCII", subtitle:"Dai vita all'arte testuale con il movimento", category:"fun",
    ...
    steps:["Descrivi l'animazione che vuoi (cosa si muove, come si muove, l'effetto generale)","Chiedi all'IA di crearla come singolo file HTML usando JavaScript e un font monospace o canvas","Apri il file HTML nel browser per vedere l'animazione","Itera: chiedi all'IA di regolare la velocità, aggiungere colori, cambiare la scena o combinare effetti"],
  ...
  // ===== IA LOCALE (108) =====
  {id:108, title:"Esegui la Tua IA Locale (LLM)", subtitle:"Esegui modelli di IA sul tuo computer — senza internet", category:"coding",
    ...
    steps:["Vai su lmstudio.ai e scarica LM Studio per il tuo sistema operativo (Windows, Mac o Linux). Installalo come una normale app.","Apri LM Studio e sfoglia la libreria dei modelli. Inizia con un modello piccolo come 'Llama 3.1 8B' o 'Mistral 7B' — funzionano bene sulla maggior parte dei computer.","Clicca 'Download' sul modello scelto. Potrebbe richiedere qualche minuto a seconda della dimensione del modello (tipicamente 4-8 GB).","Una volta scaricato, vai alla scheda 'Chat', seleziona il tuo modello e inizia a chattare! Funziona proprio come ChatGPT ma gira interamente sul tuo computer.","Esplora le impostazioni per regolare temperatura (creatività), max token (lunghezza risposta) e prompt di sistema. Prova diversi modelli per trovare il tuo preferito."],
  ...
  // ===== ALTRI ELEMENTI =====
  {id:112, title:"Estrai una Descrizione Dettagliata di un Video", subtitle:"Ottieni analisi tecniche dettagliate di qualsiasi contenuto video", category:"video",
    ...
    steps:["Carica o condividi il video con un'IA che supporta l'input video (come Gemini o ChatGPT con vision)","Chiedi un'analisi tecnica dettagliata del video","Specifica quali aspetti vuoi analizzare: cinematografia, editing, audio, contenuto, ritmo, ecc.","Usa l'analisi per imparare tecniche, creare descrizioni di accessibilità o documentare contenuti video"],
  ...
  {id:113, title:"Estrai una Descrizione Dettagliata di un'Immagine", subtitle:"Ottieni analisi tecnica e creativa di qualsiasi immagine", category:"art",
    ...
    steps:["Carica l'immagine in un'IA che supporta la visione (ChatGPT, Claude, Gemini)","Chiedi un'analisi tecnica e artistica dettagliata","Specifica il tipo di analisi: critica artistica, analisi tecnica, descrizione di accessibilità o tutto","Usa gli insight per migliorare il tuo lavoro o creare descrizioni appropriate delle immagini"],
  ...
  {id:114, title:"Crea Schemi di Colori e Palette", subtitle:"Genera combinazioni di colori armoniose per qualsiasi progetto", category:"art",
    ...
    steps:["Descrivi l'atmosfera, il tema o lo scopo del tuo progetto","Chiedi all'IA di generare una palette colori con codici hex specifici","Richiedi linee guida d'uso: quale colore per sfondi, testo, accenti, ecc.","Chiedi variazioni: versioni più chiare/scure, palette complementari o alternative accessibili"],
  ...
  {id:115, title:"Crea Kit di Brand e Linee Guida Visive", subtitle:"Costruisci sistemi di identità visiva completi con l'IA", category:"business",
    ...
    steps:["Descrivi il tuo brand: nome, missione, pubblico target, personalità e valori","Chiedi all'IA di generare un kit di brand completo con tutte le linee guida visive","Rivedi e perfeziona ogni sezione — regola colori, font e tono per adattarli alla tua visione","Esporta le linee guida come documento di riferimento per chiunque crei contenuti per il tuo brand"],
  ...
  {id:116, title:"Chiedi all'IA di Fare l'Avvocato del Diavolo", subtitle:"Rafforza le tue idee facendo sfidare le tue argomentazioni dall'IA", category:"productivity",
    ...
    steps:["Condividi la tua argomentazione, saggio, piano o idea con l'IA","Chiedile di fare l'avvocato del diavolo e trovare ogni debolezza","Rivedi le controargomentazioni — quali sono valide?","Rafforza il tuo lavoro originale affrontando le migliori obiezioni","Ripeti: chiedi all'IA di sfidare la versione migliorata per un altro round"],
  ...
  // ===== NUOVI ELEMENTI (117-122) =====
  {id:117, title:"Crea Dashboard Interattive dai Dati", subtitle:"Trasforma dati grezzi in dashboard visive professionali con grafici e statistiche", category:"business",
    ...
    steps:["Prepara i tuoi dati: carica un file (Excel, CSV), incolla una tabella o descrivi i dati che vuoi visualizzare","Chiedi all'IA di creare una dashboard HTML a pagina singola con grafici e statistiche","Specifica quali metriche contano: totali, medie, tendenze, confronti, distribuzioni","Chiedi elementi interattivi: filtri, intervalli di date, selettori di scenario","Richiedi tipi di grafici specifici: barre, linee, torta, area, dispersione, o lascia scegliere all'IA","Itera: chiedi all'IA di aggiungere KPI, codifica a colori, layout responsive o opzioni di esportazione"],
  ...
  {id:118, title:"Crea Simulazioni di Scenari Interattive", subtitle:"Costruisci modelli what-if dinamici con slider, input e risultati in tempo reale", category:"business",
    ...
    steps:["Descrivi lo scenario che vuoi modellare: quali sono le variabili, quali sono i risultati?","Fornisci i tuoi dati, intervalli e ipotesi (o chiedi all'IA di suggerire valori ragionevoli)","Chiedi all'IA di creare una pagina HTML interattiva con slider, input e preset di scenario","Specifica quali risultati mostrare: grafici, statistiche riassuntive, raccomandazioni, avvertimenti","Chiedi commenti automatici che spieghino cosa significa ogni risultato","Testa diversi scenari e itera"],
  ...
  {id:119, title:"Analizza Curriculum e Pre-Seleziona Candidati", subtitle:"Lascia che l'IA pre-selezioni, valuti e classifichi i candidati in base ai tuoi criteri", category:"business",
    ...
    steps:["Definisci il ruolo lavorativo, le competenze richieste, le qualifiche preferite e i requisiti imprescindibili","Crea i tuoi criteri di punteggio: cosa conta di più?","Incolla o carica i curriculum/CV da analizzare","Chiedi all'IA di valutare ogni candidato rispetto ai tuoi criteri e classificarli","Rivedi l'analisi dell'IA e segnala i candidati per un esame più approfondito","Usa i risultati come punto di partenza — conduci sempre colloqui personali"],
  ...
  {id:120, title:"Ricerca un Cliente o Prospect", subtitle:"Genera brief completi su prospect, clienti o brand per vincere business", category:"business",
    ...
    steps:["Fornisci il nome dell'azienda o della persona e i dettagli che già conosci","Chiedi all'IA di ricercare e compilare un brief completo","Specifica cosa ti serve: panoramica aziendale, persone chiave, notizie recenti, pain point, competitor","Chiedi all'IA di suggerire punti di discussione e angolazioni per il tuo pitch","Richiedi un riepilogo di una pagina da consultare prima di chiamate o presentazioni","Aggiorna il brief regolarmente"],
  ...
  {id:121, title:"Adatta l'Apprendimento al Tuo Stile Personale", subtitle:"Personalizza qualsiasi argomento in base a come impari meglio", category:"learning",
    ...
    steps:["Identifica il tuo stile di apprendimento preferito (visivo, uditivo, cinestetico, lettura/scrittura, spaziale)","Indica all'IA l'argomento che vuoi imparare e il tuo stile preferito","Chiedi all'IA di presentare il materiale in quel formato","Richiedi formati alternativi per rinforzare la comprensione","Combina stili per una comprensione più profonda"],
  ...
  {id:122, title:"Crea Simulazioni Interattive di Argomenti di Studio", subtitle:"Costruisci modelli esplorabili di ciò che stai studiando", category:"learning",
    ...
    steps:["Descrivi l'argomento o il concetto che vuoi simulare","Chiedi all'IA di creare una simulazione HTML interattiva","Specifica quali variabili vuoi controllare (slider, pulsanti, input)","Richiedi rappresentazioni visive (grafici, animazioni, diagrammi)","Apri il file HTML generato nel browser per interagire","Modifica ed estendi la simulazione chiedendo all'IA aggiunte"],
